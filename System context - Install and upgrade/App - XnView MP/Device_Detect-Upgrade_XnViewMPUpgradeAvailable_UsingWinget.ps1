...
<#
    .SYNOPSIS
        Uses Winget to see if a new version is available for XnView MP.
...
# Assets
## Scenario specific
$FileDetectPath  = [string] '{0}\XnViewMP\xnviewmp.exe' -f $env:ProgramW6432
$WingetPackageId = [string] 'XnSoft.XnViewMP'
