...
<#
    .SYNOPSIS
        Uses Winget to see if a new version is available for TeamViewer.
...
# Assets
## Scenario specific
$FileDetectPath  = [string] '{0}\TeamViewer\TeamViewer.exe' -f $env:ProgramW6432
$WingetPackageId = [string] 'TeamViewer.TeamViewer'
