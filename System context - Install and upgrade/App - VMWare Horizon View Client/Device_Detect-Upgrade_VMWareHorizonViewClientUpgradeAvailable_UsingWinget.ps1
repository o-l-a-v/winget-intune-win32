...
<#
    .SYNOPSIS
        Uses Winget to see if a new version is available for VMWare Horizon View Client.
...
# Assets
## Scenario specific
$FileDetectPath  = [string] '{0}\VMware\VMware Horizon View Client\vmware-view.exe' -f ${env:ProgramFiles(x86)}
$WingetPackageId = [string] 'VMware.HorizonClient'
